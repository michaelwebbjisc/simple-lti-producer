...
namespace LtiLibrary.Lti1
{
        ...
        : OAuthRequest, IBasicLaunchRequest, IOutcomesManagementRequest, IContentItemSelectionRequest, IContentItemSelectionResponse
    {
        ...
        public bool AcceptCopyAdvice
        {
            ...
            set
            {
                Parameters[LtiConstants.AcceptCopyAdviceParameter] = value.ToString().ToLowerInvariant();
            }
        }
        ...
        public bool AcceptMultiple
        {
            ...
            set
            {
                Parameters[LtiConstants.AcceptMultipleParameter] = value.ToString().ToLowerInvariant();
            }
        }
        ...
        public bool AcceptUnsigned
        {
            ...
            set
            {
                Parameters[LtiConstants.AcceptUnsignedParameter] = value.ToString().ToLowerInvariant();
            }
        }
